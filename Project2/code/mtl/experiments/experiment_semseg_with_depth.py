...
class ExperimentSemsegDepth(pl.LightningModule):
    def __init__(self, cfg):
        ...
        # log
        self.depth_log_meters_mean = self.datasets[SPLIT_TRAIN].depth_log_meters_mean
        self.depth_log_meters_stddev = self.datasets[SPLIT_TRAIN].depth_log_meters_stddev
        ...
        print(self.net)
        print(count_parameters(self.net))
        ...
        self.datasets[SPLIT_TRAIN].set_transforms(get_transforms(
            ...
            depth_meters_mean=self.depth_log_meters_mean, # modified to be log 
            depth_meters_stddev=self.depth_log_meters_stddev,
            if_log=True
        ))
    ...
    def inference_step(self, batch):
        ...
        # covert to log
        y_hat_depth_meters = (
                torch.exp(y_hat_depth * self.depth_log_meters_stddev + self.depth_log_meters_mean)
        ).clamp(self.depth_meters_min, self.depth_meters_max)
    ...
    def validation_step(self, batch, batch_nb):
        ...
        # change to log
        y_depth_meters = torch.exp(y_depth * self.depth_log_meters_stddev + self.depth_log_meters_mean)
