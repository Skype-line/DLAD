...
def command_line_parser():
    ...
    parser.add_argument(
        '--model_name', type=str, default='deeplabv3p', choices=['deeplabv3p', 'deeplabv3pbranch', 
        'deeplabv3pdistillation', 'deeplabv3pSASE', 'deeplabv3pGate', 'deeplabv3pUpConv', 'deeplabv3pASPPSASE', 
        'deeplabv3pUpConvSkipSE', 'deeplabv3pUpConvSkipRASE'], 
