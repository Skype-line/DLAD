...
from mtl.models.model_parts import Encoder, get_encoder_channel_counts, ASPP, DecoderDeeplabV3p, SqueezeAndExcitation
...
class ModelDeepLabV3Plus(torch.nn.Module):
    def __init__(self, cfg, outputs_desc):
        ...
        self.SE = SqueezeAndExcitation(ch_out_encoder_bottleneck)
